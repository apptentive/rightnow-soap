...
describe RightNow::Client do
  let(:client) { RightNow::Client.new("https://apptentive-test.custhelp.com/cgi-bin/apptentive-test.cfg/services/soap?wsdl", "Apptentive", "AppPassword") }
    ...
    context "with blank username or password" do
      it "should raise a setup error" do
        [
          ...
          expect { RightNow::Client.new("http://url.com", user, pass) }.to raise_error(RightNow::InvalidClientError)
        end
      end
    end
  end
  ...
  describe "#connected?" do
    context "when connected" do
      it "should return true" do
        VCR.use_cassette("successful_connection", match_requests_on: %i[method uri body]) do
    ...
    context "when not connected" do
      let(:client) { RightNow::Client.new("https://apptentive-test.custhelp.com/cgi-bin/apptentive-test.cfg/services/soap?wsdl", "Apptentive", "WrongPassword") }
      it "should return false" do
        VCR.use_cassette("failed_connection", match_requests_on: %i[method uri body]) do
  ...
  describe "#create" do
    context "Incident" do
      context "with valid parameters" do
        it "should return an Incident with full attributes" do
          VCR.use_cassette("create_incident", match_requests_on: %i[method uri body]) do
    ...
    context "Contact" do
      it "should return a Contact object" do
        VCR.use_cassette("create_contact", match_requests_on: %i[method uri body]) do
      ...
      context "with duplicate email" do
        it "should raise a duplicate error" do
          VCR.use_cassette("create_duplicate_contact", match_requests_on: %i[method uri body]) do
            contact = RightNow::Objects::Contact.new(first_name: "Mike", last_name: "Tester", email: "mike+tester4@apptentive.com.invalid")
  ...
  describe "#update" do
    context "Incident" do
      context "with valid params" do
        it "should return an Incident with full attributes" do
          VCR.use_cassette("update_incident", match_requests_on: %i[method uri body]) do
      ...
      context "with invalid params" do
        it "should raise an error" do
          VCR.use_cassette("update_invalid_incident", match_requests_on: %i[method uri body]) do
  ...
  describe "#find" do
    context "Incident" do
      it "should return an Incident object" do
        VCR.use_cassette("find_incident", match_requests_on: %i[method uri body]) do
          incident = RightNow::Objects::Incident.new(id: "54947325")
      ...
      context "when incident is not in Oracle" do
        it "should return nil" do
          VCR.use_cassette("no_incident_found", match_requests_on: %i[method uri body]) do
    ...
    context "Contact" do
      it "should return a Contact object" do
        VCR.use_cassette("find_contact", match_requests_on: %i[method uri body]) do
      ...
      context "when user is not in Oracle" do
        it "should return nil" do
          VCR.use_cassette("no_contact_found", match_requests_on: %i[method uri body]) do
      ...
      context "when multiple contact records exist with the same email" do
        it "should only return 1 record" do
          VCR.use_cassette("find_contact_with_multiple", match_requests_on: %i[method uri body]) do
